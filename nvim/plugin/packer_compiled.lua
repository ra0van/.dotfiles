...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-context-commentstring", "nvim-treesitter-textobjects", "nvim-ts-autotag", "playground", "nvim-treesitter-refactor" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-media-files.nvim", "telescope-symbols.nvim", "telescope-fzf-native.nvim" },
    config = { "\27LJ\2\n5\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\26ravan.setup.telescope\frequire\0" },
    loaded = true,
    only_config = true,
